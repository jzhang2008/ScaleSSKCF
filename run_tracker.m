...
params.search_area_scale = 2.5; %3.0        % the size of the training/detection area proportional to the target size  4.0
params.filter_max_area = 60^2;          % the size of the training/detection area in feature grid cells  50^2
...
params.learning_rate = 0.015;%0.02;			% tracking model learning rate (denoted "eta" in the paper) 0.015
...
params.part_sigma_factor =0.2;%0.2;          % 0.2
...
params.C         =1e4;
params.beta      = 0.05;%;
params.gamma     = 0.4;  %0.35
% kernel parameters
params.kernel.sigma = 0.5;%0.2;
%-----------------------------------
params.PSR_range    = 0.15;
...
[positions, fps] = MS_PSVKCFT(params);
